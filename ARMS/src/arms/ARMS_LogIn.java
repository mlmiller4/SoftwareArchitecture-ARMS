...
public class ARMS_LogIn {
	...
	private void initialize() {
		...
		btnLoginStudentButton.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		...
		btnLoginAdminButton.setFont(new Font("Times New Roman", Font.PLAIN, 18));
		...
		lblAcademicResourceManagement.setFont(new Font("Times New Roman", Font.BOLD, 25));
